...
//~~~~~~~~~~~~~~~~~~~~~~
    ...
    def loadSpriteSheet(String _name, int _tdx, int _tdy, int _etx, int _ety){
            try {
...
//~~~~~~~~~~~~~~~~~~~~~~
    ...
    def rotateXYZ(float _x, float _y, float _z) {
        rotateX(radians(_x));
        rotateY(radians(_y));
        rotateZ(radians(_z));
    }
